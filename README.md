...
| 기능 | Method | URL |
|------|--------|-----|
| 객실 목록 | GET | `http://localhost:8080/api/rooms` |
| 예약 생성 | POST | `http://localhost:8080/api/reservations` |
| 결제 | POST | `http://localhost:8080/api/reservations/{id}/pay` |
| 예약 승인 (Host) | POST | `http://localhost:8080/api/reservations/{id}/approve` |
| 예약 취소 | POST | `http://localhost:8080/api/reservations/{id}/cancel` |
| 환불 | POST | `http://localhost:8080/api/reservations/{id}/refund` |
| 결제 이력 조회 | GET | `http://localhost:8080/api/payments` |
